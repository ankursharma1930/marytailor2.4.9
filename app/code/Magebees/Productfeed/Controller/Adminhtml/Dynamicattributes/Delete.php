...
class Delete extends \Magebees\Productfeed\Controller\Adminhtml\Dynamicattributes
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $this->messageManager->addError(
                    __('We can\'t delete Dynamicattributes right now. Please review the log and try again.')
                );
        ...
        $this->messageManager->addError(__('We can\'t find a Dynamicattributes to delete.'));
        $this->_redirect('magebees_productfeed/*/');
    }
