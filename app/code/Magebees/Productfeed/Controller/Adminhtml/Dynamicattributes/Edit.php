...
class Edit extends \Magebees\Productfeed\Controller\Adminhtml\Dynamicattributes
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            $model->load($id);
            if (!$model->getId()) {
                $this->messageManager->addError(__('This dynamicattributes no longer exists.'));
        ...
        $this->_coreRegistry->register('current_magebees_productfeed_dynamicattributes', $model);
        $this->_initAction();
