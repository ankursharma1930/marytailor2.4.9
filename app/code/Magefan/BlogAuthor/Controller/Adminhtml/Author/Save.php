...
namespace Magefan\BlogAuthor\Controller\Adminhtml\Author;

use Magefan\BlogAuthor\Model\Author;

/**
 * Blog author save controller
 */
class Save extends \Magefan\BlogAuthor\Controller\Adminhtml\Author
{
    /**
     * @var string
     */
    protected $_allowedKey = 'Magefan_Blog::author_save';
                ...
                if (!empty($data[$key]['delete'])) {
                    ...
                    if (isset($data[$key][0]['name']) && isset($data[$key][0]['tmp_name'])) {
                        ...
                        $imageUploader = $this->_objectManager->get(
                            \Magefan\BlogAuthor\ImageUpload::class
                        );
