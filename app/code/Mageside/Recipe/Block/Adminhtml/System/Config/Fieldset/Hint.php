 ...
 */
namespace Mageside\Recipe\Block\Adminhtml\System\Config\Fieldset;

use Magento\Framework\Data\Form\Element\AbstractElement;
use Magento\Backend\Block\Template\Context;
use Magento\Framework\App\ProductMetadataInterface;
use Magento\Framework\Module\ModuleList\Loader;
use Mageside\Recipe\Helper\Config as Helper;
...
class Hint extends \Magento\Backend\Block\Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Mageside_Recipe::system/config/fieldset/hint.phtml';
    ...
    public function getVersion()
    {
        ...
        $v = "";
        if (isset($modules['Mageside_Recipe'])) {
            $v = "v" . $modules['Mageside_Recipe']['setup_version'];
        }
