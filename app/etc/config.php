...
return [
    'modules' => [
        ...
        'Plumrocket_Base' => 1,
        'Plumrocket_ShippingTracking' => 1,
        'Hyva_DolphinProductfaq' => 1,
        'Hyva_LumaCheckout' => 1,
        'Magebees_Productfeed' => 1,
        ...
        'Mageplaza_GeoIP' => 1,
        'Mageplaza_Osc' => 1,
        'Mageplaza_QuickCart' => 1,
        'Mageplaza_ReviewReminder' => 1,
        'Mageplaza_Smtp' => 1,
        'Mageside_Recipe' => 1,
        'Magewirephp_Magewire' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Report' => 1,
        'Hyva_MirasvitRewards' => 1,
        'Mirasvit_RewardsAdminUi' => 1,
        'Mirasvit_RewardsApi' => 1,
        'Hyva_MirasvitRewardsBehavior' => 1,
        'Hyva_MirasvitRewardsCatalog' => 1,
        'Hyva_MirasvitRewardsCheckout' => 1,
        'Hyva_MirasvitRewardsCustomerAccount' => 1,
        'Hyva_MirasvitSeo' => 1,
        'Mirasvit_SeoAi' => 0,
        'Mirasvit_SeoAudit' => 0,
        ...
        'Plumrocket_Token' => 1,
        'Plumrocket_AmpEmailApi' => 0,
        'Plumrocket_Checkoutspage' => 1,
        'Plumrocket_Bestsellers' => 1,
        'Hyva_PlumrocketCheckoutspage' => 1,
        'Plumrocket_ExtendedAdminUi' => 1,
        'Plumrocket_GoogleCustomerReviews' => 1,
        'Hyva_PlumrocketShippingTracking' => 1,
        'Plumrocket_AmpEmail' => 0,
